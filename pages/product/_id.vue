      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4">
          <ul class="flex flex-wrap items-center mb-16">
            ...
            <li><a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#">Apple iPhone 12 PRO</a></li>
          </ul>
        </div>
        <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
          <div class="flex -mx-4 flex-wrap items-center justify-between lg:justify-start lg:items-start xl:items-center">
            ...
            <div class="w-full sm:w-9/12 px-4">
              <img class="mb-5" src="uinel-assets/images/ecommerce-product-info/ph-photo1.png" alt="">
        ...
        <div class="w-full lg:w-1/2 px-4">
          <div class="max-w-md mb-6">
            ...
            <h2 class="mt-6 mb-4 text-5xl md:text-7xl lg:text-8xl font-heading font-medium">Apple iPhone 12 Pro (128GB) - Silver</h2>
