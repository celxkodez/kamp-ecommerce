      ...
      <div class="flex flex-wrap items-center -mx-4">
        ...
        <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
          <div class="flex flex-col items-center">
            <div class="w-full sm:w-9/12 px-4">
              <img
                class="mb-5 w-full rounded-lg h-full"
            ...
            <div class="w-full px-4 flex items-center justify-center">
              ...
              <a class="h-10 w-10 mx-2" href="#">
                <img
                  class="h-full rounded-xl w-full"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaCNta7e7TjmaL5Y2tmBMG1LOPXMwwtq0T2w&usqp=CAU"
                  alt=""
                />
              </a>
              <a class="h-10 w-10 mx-2" href="#">
        ...
        <div class="w-full lg:w-1/2 px-4">
          <div class="max-w-md mb-6">
            <h4 class="text-xs text-gray-400 tracking-wider">APPLE Company</h4>
            <h2
              class="mb-4 text-5xl md:text-7xl lg:text-4xl font-heading font-medium"
            >
          ...
          <div class="mb-6">
            ...
            <button
              class="inline-flex items-center justify-center p-1 rounded-full border border-gray-300"
            >
              <div class="w-6 h-6 rounded-full bg-white"></div>
            </button>
            <button
              class="inline-flex items-center justify-center p-1 rounded-full border border-transparent"
            >
