  ...
  <section class="pt-12 pb-24 overflow-hidden bg-blueGray-100">
    <div class="container px-4 mx-auto">
      ...
      <div class="mb-8 pb-8 border-b border-gray-200 border-opacity-40">
        <h1 class="text-center text-9xl xl:text-10xl font-heading font-medium">Your cart</h1>
      </div>
      <div class="flex flex-wrap -mx-4 mb-14 xl:mb-24">
          ...
          <div class="py-12 px-8 md:px-12 bg-white rounded-3xl">
            ...
            <div class="xl:px-10">
              <div class="relative flex flex-wrap items-center xl:justify-between -mx-4 mb-8 pb-8 border-b border-gray-200 border-opacity-40">
                <div class="relative w-full md:w-auto px-4 mb-6 xl:mb-0">
                  <a class="block mx-auto max-w-max" href="#">
                    <img class="h-28 object-cover" src="uinel-assets/images/ecommerce-product-info/phone01.png" alt="">
                  </a>
                </div>
                ...
                <button class="absolute top-0 right-0 lg:mt-6 lg:-mr-4 text-gray-200 hover:text-gray-300">
              ...
              <div class="relative flex flex-wrap items-center xl:justify-between -mx-4 mb-8 pb-8 border-b border-gray-200 border-opacity-40">
                <div class="relative w-full md:w-auto px-4 mb-6 xl:mb-0">
                  <a class="block mx-auto max-w-max" href="#">
                    <img class="h-28 object-cover" src="uinel-assets/images/ecommerce-product-info/headphones.png" alt="">
                  </a>
                </div>
                <div class="w-full md:w-auto px-4 mb-6 xl:mb-0">
        ...
        <div class="w-full md:w-4/12 xl:w-3/12 px-4">
          <div class="mb-14">
            ...
            <a class="inline-block w-full lg:w-auto py-5 px-10 text-xl leading-6 text-white font-medium tracking-tighter font-heading text-center bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl" href="#">Checkout</a>
          </div>
          <div class="text-center md:text-left">
            <img class="block mb-9 mx-auto md:ml-0" src="uinel-assets/images/ecommerce-cart/procents.svg" alt="">
            <h4 class="mb-5 text-8xl font-heading font-medium">Shipping</h4>
            <p class="lg:pr-10 text-lg text-darkBlueGray-300">The nulla commodo, commodo eros.</p>
          </div>
        </div>
      </div>
